...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-50">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-50/50 blur-[120px]"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-blue-50/50 blur-[120px]"></div>
            ...
            <div className="relative w-full max-w-md px-6">
                <div className="bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-white/60 p-10">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <p className="text-slate-500 font-medium">Create your professional client portal</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        <div className="space-y-1.5">
                            <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Business Name</label>
                    ...
                    <p className="mt-10 text-center text-slate-500 font-medium text-sm">
                        ...
                        <Link href="/login" className="text-slate-900 font-black hover:opacity-70 transition-opacity underline decoration-2 decoration-indigo-500/20 underline-offset-4">
                            Sign In
                        </Link>
                    </p>
                </div>
